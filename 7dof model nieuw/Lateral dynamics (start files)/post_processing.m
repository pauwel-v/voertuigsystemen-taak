...
ylabel('Error normal forces [N]')
xlabel('t [s]')

% difference in CW
figure
plot(inputs.time, 100*data(end, :))
ylabel('Necessary extra counter-weight [%]')
xlabel('t [s]')

% plot of B
figure
plot(inputs.time, data(26 +size(data,1)/2,:))
ylabel('B [m]')
xlabel('t [s]')
...
figure
subplot(2,1,1)
plot(inputs.time, sqrt(data(1,:).^2 + data(2,:).^2))
hold on
plot(inputs.time,vehicle_param.mu .* data(3,:))
xlabel('time [s]')
ylabel('Force [N]')
legend('actual','limit')
title('Friction circle front left: without control')
subplot(2,1,2)
plot(inputs.time, sqrt(data(1+size(data,1)/2,:).^2 + data(2+size(data,1)/2,:).^2))
hold on
plot(inputs.time, vehicle_param.mu .* data(3+size(data,1)/2,:))
legend('actual','limit')
xlabel('time [s]')
ylabel('Force [N]')
title('with control')
...
figure
subplot(2,1,1)
plot(inputs.time, sqrt(data(4,:).^2 + data(5,:).^2))
hold on
plot(inputs.time,vehicle_param.mu .* data(6,:))
xlabel('time [s]')
ylabel('Force [N]')
legend('actual','limit')
title('Friction circle front right: without control')
subplot(2,1,2)
plot(inputs.time, sqrt(data(4+size(data,1)/2,:).^2 + data(5+size(data,1)/2,:).^2))
hold on
plot(inputs.time, vehicle_param.mu .* data(6+size(data,1)/2,:))
legend('actual','limit')
xlabel('time [s]')
ylabel('Force [N]')
title('with control')
...
figure
subplot(2,1,1)
plot(inputs.time, sqrt(data(7,:).^2 + data(8,:).^2))
hold on
plot(inputs.time,vehicle_param.mu .* data(9,:))
xlabel('time [s]')
ylabel('Force [N]')
legend('actual','limit')
title('Friction circle rear left: without control')
subplot(2,1,2)
plot(inputs.time, sqrt(data(7+size(data,1)/2,:).^2 + data(8+size(data,1)/2,:).^2))
hold on
plot(inputs.time, vehicle_param.mu .* data(9+size(data,1)/2,:))
legend('actual','limit')
xlabel('time [s]')
ylabel('Force [N]')
title('with control')
...
figure
subplot(2,1,1)
plot(inputs.time, sqrt(data(10,:).^2 + data(11,:).^2))
hold on
plot(inputs.time,vehicle_param.mu .* data(12,:))
xlabel('time [s]')
ylabel('Force [N]')
legend('actual','limit')
title('Friction circle rear right: without control')
subplot(2,1,2)
plot(inputs.time, sqrt(data(10+size(data,1)/2,:).^2 + data(11+size(data,1)/2,:).^2))
hold on
plot(inputs.time, vehicle_param.mu .* data(12+size(data,1)/2,:))
legend('actual','limit')
xlabel('time [s]')
ylabel('Force [N]')
title('with control')
...
%    
%     figure(555)
%     plot(p(1,:)', p(2,:)', 'b', Wrl(1,:)', Wrl(2,:)', 'g', Wrr(1,:)', Wrr(2,:)', 'g', Wfr(1,:)', Wfr(2,:)','r', Wfl(1,:)', Wfl(2,:)','r', Cm(1,:)', Cm(2,:)', 'go', 'linewidth', 2), axis([0 150 -100 5]) % AXIS([XMIN XMAX YMIN YMAX])
%     
%     hold on
%     
