...
if inputs.control_on
    F_fl_n = F_fl_n - diffCW*factor_frontrear*M*9.81/2;
    F_fr_n = F_fr_n + diffCW*factor_frontrear*M*9.81/2;
    F_rl_n = F_rl_n + diffCW*(1-factor_frontrear)*M*9.81/2;
    F_rr_n = F_rr_n - diffCW*(1-factor_frontrear)*M*9.81/2;
end
