...
F_rl_n = max(F_rl_n - dist_factor_front_rear*diffCW*M*9.81,0);

F_fl_n = max(0,F_fr_n + (1-dist_factor_front_rear) * diffCW * M*9.81);
F_rr_n = max(F_rr_n + dist_factor_front_rear * diffCW * M * 9.81,0);
% end of control bs
...
%         sign_Fx_fl; sign_Fx_fr; sign_Fx_rl; sign_Fx_rr;...
        ...
        T_l; T_r; ackermanyawrate; v_accent(1)]; % 22-26
% data = Nc;
